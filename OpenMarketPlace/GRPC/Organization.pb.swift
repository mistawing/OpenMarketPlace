...
struct Organization_orgMetadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "organization"

extension Organization_orgName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".orgName"
  ...
  static func ==(lhs: Organization_orgName, rhs: Organization_orgName) -> Bool {
...
extension Organization_orgMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".orgMetadata"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "orgName"),
  ...
  static func ==(lhs: Organization_orgMetadata, rhs: Organization_orgMetadata) -> Bool {
    if lhs.orgName != rhs.orgName {return false}
