...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NIO/NIO.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Realm/Realm.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RealmSwift/RealmSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Reflex/Reflex.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Transformer/Transformer.framework"
